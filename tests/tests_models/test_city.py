#!/usr/bin/python3
"""Module defines unittests city.py."""
...
class TestCity_to_dict(unittest.TestCase):
    """Represents the Unittests for testing to_dict
...
class TestCity_save(unittest.TestCase):
    """Represents the Unittests for testing save
    method of the City class."""
...
class TestCity_instantiation(unittest.TestCase):
    """Represents the Unittests for testing instantiation
    of the City class."""
