#!/usr/bin/python3
"""Represents module for HBNBcommand class."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Represents Unittests for testing create
...
class TestHBNBCommand_destroy(unittest.TestCase):
    """Represents the Unittests for testing destroy
    from the HBNB command interpreter."""
...
class TestHBNBCommand_all(unittest.TestCase):
    """Represent the Unittests for testing all
...
class TestHBNBCommand_help(unittest.TestCase):
    """Represents the Unittests for testing help messages
    of the HBNB command interpreter."""
...
class TestHBNBCommand_create(unittest.TestCase):
    """Represent the Unittests for testing create
    from the HBNB command interpreter."""
