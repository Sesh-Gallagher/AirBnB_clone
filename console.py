...
class HBNBCommand(cmd.Cmd):
    """
    Module that represents HBNBCommand console class
    """
    ...
    def do_create(self, arg):
        """
        Module to Create a new instance of BaseModel
    ...
    def do_show(self, arg):
        """
        Module to Show the string representation of an instance.
    ...
    def do_destroy(self, arg):
        """
        Module that Deletes an instance based on the class name and id.
    ...
    def do_all(self, arg):
        """
        Module to Print the string representation of
    ...
    def do_count(self, arg):
        """
        Module that Counts and retrieves the number of instances of a class
    ...
    def do_update(self, arg):
        """
        Module to Update an instance by adding or updating an attribute.
